...
if  s:MSWIN
  " ==========  MS Windows  ======================================================
  let s:esc_chars 	  = ''
	call PerlSetGlobalVariable( 'Perl_CodeSnippets', s:plugin_dir.'perl-support/codesnippets/' )
  "
	let s:Perl_Display  = ''
  ...
  " ==========  Linux/Unix  ======================================================
    ...
    let s:plugin_dir  	= $VIM.'/vimfiles/'
		...
		let s:plugin_dir  	= $HOME.'/.vim/bundle/perl-support/'
	endif
...
function! Perl_SyntaxCheck ()
  ...
  "
    ...
    "
    exe ':set makeprg=perl\ -c\ -I' . l:includes
...
if has("autocmd")
	...
	autocmd BufNewFile  *.pm  call Perl_InsertTemplate('comment.file-description-pm') | call RenamePackageFromPath()
