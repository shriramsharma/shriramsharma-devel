...
"   'For code surgeons and web fringds everywhere'
...
"   name  fringd, now  all  vimsters can  truly frolic  in
"   their Vim Gardens

" Options:
"   g:fringd_light_comments
...
" Colors for the User Interface.
    ...
    if exists("g:fringd_light_comments")
...
" Colors for the User Interface.
    ...
    exec "hi String         cterm=NONE   ctermfg=197  ctermbg=NONE"
    ...
    exec "hi Identifier     cterm=NONE   ctermfg=220  ctermbg=NONE"
    exec "hi Function       cterm=BOLD   ctermfg=253  ctermbg=NONE"
    exec "hi Statement      cterm=BOLD   ctermfg=249  ctermbg=NONE"

    exec "hi Define         cterm=BOLD   ctermfg=68  ctermbg=NONE"
    exec "hi Conditional    cterm=BOLD   ctermfg=149  ctermbg=NONE"

    exec "hi Repeat         cterm=BOLD   ctermfg=202  ctermbg=NONE"
    exec "hi Label          cterm=BOLD   ctermfg=225  ctermbg=NONE"
    exec "hi Operator       cterm=BOLD   ctermfg=039  ctermbg=NONE"
...
let g:colors_name = "fringd"
let colors_name   = "fringd"
