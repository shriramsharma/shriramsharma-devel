...
"   'For code surgeons and web fringd2s everywhere'
...
"   name  fringd2, now  all  vimsters can  truly frolic  in
"   their Vim Gardens

" Options:
"   g:fringd2_light_comments
...
" Colors for the User Interface.
    ...
    if exists("g:fringd2_light_comments")
...
" Colors for the User Interface.
    ...
    exec "hi String         cterm=NONE   ctermfg=203  ctermbg=NONE"
    ...
    exec "hi Identifier     cterm=NONE   ctermfg=173  ctermbg=NONE"
    exec "hi Function       cterm=NONE   ctermfg=049  ctermbg=NONE"
    ...
    exec "hi Operator       cterm=BOLD   ctermfg=193  ctermbg=NONE"
...
let g:colors_name = "fringd2"
let colors_name   = "fringd2"
